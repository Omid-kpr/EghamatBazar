...
const CardButtons = ({ isActive, id }) => {
    ...
    return (
        <div className="flex justify-center w-[80%] max-w-96 mt-4">
            <Button variant="secondary" className="text-md text-black w-1/3 mx-1">
                ویرایش
                <FaRegEdit style={{ fontSize: "1em" }} className='ml-2' />
            </Button>
            <button
                onClick={clickHandler}
                className={cn("text-md text-white w-2/3 mx-1 p-0 rounded-sm flex justify-center items-center",
